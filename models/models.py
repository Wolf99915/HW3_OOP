...
class Plant(Model):
    ...
    def get_by_id(cls, id):
        ...
        for workers in get_employees_plant:
            if workers['type_of_work'] == 'plant' and workers['object_id'] == str(plant_dict['id']):
                print(workers['name'])
...
class Salon(Model):
    ...
    def get_by_id(cls, id):
        ...
        for workers in get_employees:
            if workers['type_of_work'] == 'salon' and workers['object_id'] == str(salon_dict['id']):
                print(workers['name'])
